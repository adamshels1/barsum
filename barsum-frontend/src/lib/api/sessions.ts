...
export const sessionsApi = {
  ...
  getPartText: (id: string) =>
    apiClient.get(`/sessions/${id}/text`).then((r) => r.data) as Promise<{ text: string | null; imageUrl: string | null; audioUrl: string | null; title: string | null; partNumber: number }>,
