...
export default function ParentCabinetPage() {
  ...
  return (
    <main style={{ minHeight: "100dvh", padding: "0 0 32px" }}>
      ...
      {/* Запросы от детей (мечты + награды) — выше подтверждения чтения:
          неодобренная мечта блокирует ребёнку накопление, а список сессий
          длинный, и запросы в нём терялись. */}
      <ChildRequestsInbox />
